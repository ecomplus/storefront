...
- **deps:** update all non-major dependencies ([#1294](https://github.com/ecomplus/storefront/issues/1294)) ([d2b4d06](https://github.com/ecomplus/storefront/commit/d2b4d06670ef92057bb4b6e8ae18a7ea9e06dd56))

## [5.20.65](https://github.com/ecomplus/storefront/compare/@ecomplus/storefront-framework@5.20.64...@ecomplus/storefront-framework@5.20.65) (2026-07-03)

### Bug Fixes

- **deps:** update all non-major dependencies ([#1288](https://github.com/ecomplus/storefront/issues/1288)) ([aad5673](https://github.com/ecomplus/storefront/commit/aad5673eac6d09244579195a894d50ed3f6b8f18))

## [5.20.64](https://github.com/ecomplus/storefront/compare/@ecomplus/storefront-framework@5.20.63...@ecomplus/storefront-framework@5.20.64) (2026-06-17)

### Bug Fixes

- **deps:** update all non-major dependencies ([#1257](https://github.com/ecomplus/storefront/issues/1257)) ([2d858a9](https://github.com/ecomplus/storefront/commit/2d858a9fdfe95cea2337a0d4d3cfd833ef17502b))
- **deps:** update all non-major dependencies ([#1258](https://github.com/ecomplus/storefront/issues/1258)) ([bd1f6af](https://github.com/ecomplus/storefront/commit/bd1f6af078fe3f1b0f76c6cb8343689dd3039c72))
- **deps:** update all non-major dependencies ([#1259](https://github.com/ecomplus/storefront/issues/1259)) ([787dbbe](https://github.com/ecomplus/storefront/commit/787dbbeee6d12f9521b20cccedb7c633aced69fa))
- **deps:** update all non-major dependencies ([#1260](https://github.com/ecomplus/storefront/issues/1260)) ([7e27eb1](https://github.com/ecomplus/storefront/commit/7e27eb12b4032a76b6d064d77a9c9968d365b554))
...
- **deps:** update all non-major dependencies ([#1277](https://github.com/ecomplus/storefront/issues/1277)) ([f63b47d](https://github.com/ecomplus/storefront/commit/f63b47dfed96d672b090bd41853dc5a34ba3208b))
- **deps:** update all non-major dependencies ([#1283](https://github.com/ecomplus/storefront/issues/1283)) ([04868b5](https://github.com/ecomplus/storefront/commit/04868b5c2d03839f6ace35e519659e60858416c5))

## [5.20.63](https://github.com/ecomplus/storefront/compare/@ecomplus/storefront-framework@5.20.62...@ecomplus/storefront-framework@5.20.63) (2026-04-17)

### Bug Fixes

- **deps:** update all non-major dependencies ([#1230](https://github.com/ecomplus/storefront/issues/1230)) ([63ebccf](https://github.com/ecomplus/storefront/commit/63ebccfd7f1d62168e2fa1ae7afe02d52fc51dbb))
- **deps:** update all non-major dependencies ([#1234](https://github.com/ecomplus/storefront/issues/1234)) ([b27ed27](https://github.com/ecomplus/storefront/commit/b27ed279b4a6844da7693b989823bd7546f7c2d7))
- **deps:** update all non-major dependencies ([#1237](https://github.com/ecomplus/storefront/issues/1237)) ([97480d1](https://github.com/ecomplus/storefront/commit/97480d158eabd0f7fe9562cb6d33fc8807114694))
- **deps:** update all non-major dependencies ([#1239](https://github.com/ecomplus/storefront/issues/1239)) ([f71114a](https://github.com/ecomplus/storefront/commit/f71114a33e88f0b34558f82b612c896f78cbfb24))
- **deps:** update all non-major dependencies ([#1249](https://github.com/ecomplus/storefront/issues/1249)) ([50a4599](https://github.com/ecomplus/storefront/commit/50a45996ca520cb167da47a1f76983f0761e66d4))
- **deps:** update all non-major dependencies ([#1253](https://github.com/ecomplus/storefront/issues/1253)) ([88db38f](https://github.com/ecomplus/storefront/commit/88db38f47fb7ebca9a998919c3bac4d15e904666))
...
## [5.20.60](https://github.com/ecomplus/storefront/compare/@ecomplus/storefront-framework@5.20.59...@ecomplus/storefront-framework@5.20.60) (2026-01-20)

### Bug Fixes

- **deps:** update all non-major dependencies ([#1191](https://github.com/ecomplus/storefront/issues/1191)) ([16ce03b](https://github.com/ecomplus/storefront/commit/16ce03b9a452861099eeb61954e5d22145985627))
- **deps:** update all non-major dependencies ([#1194](https://github.com/ecomplus/storefront/issues/1194)) ([ace49ae](https://github.com/ecomplus/storefront/commit/ace49aedaff5be03d0500c467872581d580a71be))
- **deps:** update all non-major dependencies ([#1197](https://github.com/ecomplus/storefront/issues/1197)) ([94ebb9b](https://github.com/ecomplus/storefront/commit/94ebb9b1c0dac0832ecb28f758f01d3d1e72bcfa))
- **deps:** update all non-major dependencies ([#1204](https://github.com/ecomplus/storefront/issues/1204)) ([9096374](https://github.com/ecomplus/storefront/commit/9096374b535a07086b0f6a7553636decb6e735d2))
- **deps:** update all non-major dependencies ([#1206](https://github.com/ecomplus/storefront/issues/1206)) ([08bbe19](https://github.com/ecomplus/storefront/commit/08bbe19c5057a442ad6553b86976c0586a44ad56))
- **deps:** update all non-major dependencies ([#1211](https://github.com/ecomplus/storefront/issues/1211)) ([69ec07f](https://github.com/ecomplus/storefront/commit/69ec07fcb4aaa538782df67ac665d43fc8a9e090))
- **deps:** update all non-major dependencies ([#1213](https://github.com/ecomplus/storefront/issues/1213)) ([ae20182](https://github.com/ecomplus/storefront/commit/ae201821f68c4e8b658f0a890ad589c6a1bdd319))
- **deps:** update all non-major dependencies to ^7.28.5 ([#1189](https://github.com/ecomplus/storefront/issues/1189)) ([dd19187](https://github.com/ecomplus/storefront/commit/dd191872518d248c816f4c0b51eaa51d1fba14dd))

## [5.20.59](https://github.com/ecomplus/storefront/compare/@ecomplus/storefront-framework@5.20.58...@ecomplus/storefront-framework@5.20.59) (2025-10-16)

### Bug Fixes

- **deps:** update all non-major dependencies ([#1174](https://github.com/ecomplus/storefront/issues/1174)) ([fa052a1](https://github.com/ecomplus/storefront/commit/fa052a150be4b3c09d82a26beb62eb1eb8d4e7b6))
- **deps:** update all non-major dependencies ([#1180](https://github.com/ecomplus/storefront/issues/1180)) ([c9d5355](https://github.com/ecomplus/storefront/commit/c9d5355faf0dda8b286a212035df37688e6c56bf))
- **deps:** update all non-major dependencies ([#1181](https://github.com/ecomplus/storefront/issues/1181)) ([bab68bf](https://github.com/ecomplus/storefront/commit/bab68bff7889898526e8b7054cb91098c000ab67))

## [5.20.58](https://github.com/ecomplus/storefront/compare/@ecomplus/storefront-framework@5.20.57...@ecomplus/storefront-framework@5.20.58) (2025-09-02)

**Note:** Version bump only for package @ecomplus/storefront-framework

## [5.20.57](https://github.com/ecomplus/storefront/compare/@ecomplus/storefront-framework@5.20.56...@ecomplus/storefront-framework@5.20.57) (2025-09-01)

### Bug Fixes

- **deps:** update all non-major dependencies ([#1166](https://github.com/ecomplus/storefront/issues/1166)) ([ae3d137](https://github.com/ecomplus/storefront/commit/ae3d13756868b6001bff23cfa3138c71ee633eb2))
- **deps:** update all non-major dependencies ([#1169](https://github.com/ecomplus/storefront/issues/1169)) ([e3e2706](https://github.com/ecomplus/storefront/commit/e3e2706202f373fff67684cdb2715da232b9cd3c))
...
## [5.20.54](https://github.com/ecomplus/storefront/compare/@ecomplus/storefront-framework@5.20.53...@ecomplus/storefront-framework@5.20.54) (2025-06-25)

### Bug Fixes

- **deps:** update all non-major dependencies ([#1151](https://github.com/ecomplus/storefront/issues/1151)) ([878db65](https://github.com/ecomplus/storefront/commit/878db65209dde317629eb03114265f448282cb81))
- **deps:** update all non-major dependencies ([#1153](https://github.com/ecomplus/storefront/issues/1153)) ([7c90583](https://github.com/ecomplus/storefront/commit/7c90583459a6074f63201f50ecf0b2ae62123158))
- **deps:** update all non-major dependencies ([#1156](https://github.com/ecomplus/storefront/issues/1156)) ([938bb50](https://github.com/ecomplus/storefront/commit/938bb50ac32f9633a27e69eefffd21c95bae8697))
- **deps:** update all non-major dependencies ([#1157](https://github.com/ecomplus/storefront/issues/1157)) ([6b14eef](https://github.com/ecomplus/storefront/commit/6b14eef53417a2284c60ceb41155315fbd505921))
- **deps:** update all non-major dependencies ([#1161](https://github.com/ecomplus/storefront/issues/1161)) ([91330a6](https://github.com/ecomplus/storefront/commit/91330a6b452f86843ca43a8160b053a49560cf20))
...
## [5.20.51](https://github.com/ecomplus/storefront/compare/@ecomplus/storefront-framework@5.20.50...@ecomplus/storefront-framework@5.20.51) (2025-01-25)
