...
/* harmony default export */ var EcomSearchvue_type_script_lang_js_ = ({
          ...
          var callback = function callback(err, body) {
            if (err) {
              ...
              if (suggest) {
                ...
                var fixedTerm = val;
                vm.suggestedTerms = [];
                suggest.words.forEach(function (_ref2) {
  ...
  methods: {
    ...
    searchProducts: function searchProducts(callback, term) {
