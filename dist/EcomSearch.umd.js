(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["EcomSearch"] = factory();
	else
		root["EcomSearch"] = factory();
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_EcomSearch_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("558d");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_EcomSearch_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_EcomSearch_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_EcomSearch_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
if (DB_HISTORY) {
  storage_history = localStorage.getItem(DB_HISTORY);

  if (typeof storage_history === 'string') {
    storage_history = storage_history.split('||');
  }
}
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./src/EcomSearch.js?vue&type=script&lang=js&
...
/* harmony default export */ var EcomSearchvue_type_script_lang_js_ = ({
  name: 'EcomSearch',
  props: {
    overlay: {
      type: Boolean,
  ...
  created: function created() {
    ...
    if (!this.presetedTerms) {// TODO: get general popular terms on Search API
    }

    if (!this.presetedItems) {
      // get most popular items
      // query Search API without term
      this.searchProducts(function (err, body) {
        if (err) {
          console.error(err);
        } else {
  ...
  computed: {
    ...
    inputValue: {
      ...
      set: function set(val) {
        this.term = val; // handle v-model

        this.$emit('input', val);
        this.suggestedTerms = [];

        if (val && val.length > 2) {
          var vm = this; // get products and completed terms from E-Com Plus Search API
          ...
          var callback = function callback(err, body) {
            if (err) {
              ...
              if (suggest) {
                ...
                var suggestTerm = val;
                var autoFixTerm = val;
                var words = suggest.words;
                words.forEach(function (_ref2) {
                  var options = _ref2.options,
                      text = _ref2.text;

                  if (options.length) {
                    var opt = options[0]; // check score if auto fix enabled

                    if (vm.autoFixScore > 0 && opt.score >= vm.autoFixScore && // prevent autocomplete
    ...
    label: function label() {
      ...
      return this.placeholder || lib_dictionary('search_products', this.lang);
    },
    listTerms: function listTerms() {
  ...
  methods: {
    ...
    truncateString: function truncateString(str, ln) {
    ...
    formatMoney: function formatMoney(price) {
      ...
      return Ecom.methods.formatMoney(price, this.decimalDelimiter, this.thousandsDelimiter, this.currencyNumFixed);
    },
    ...
    onPromotion: function onPromotion(item) {
  ...
  watch: {
    ...
    buttonOnly: function buttonOnly(val) {
      this.showInput = !val;
    }
  }
});
// CONCATENATED MODULE: ./src/EcomSearch.js?vue&type=script&lang=js&
 /* harmony default export */ var src_EcomSearchvue_type_script_lang_js_ = (EcomSearchvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/EcomSearch.scss?vue&type=style&index=0&lang=scss&
var EcomSearchvue_type_style_index_0_lang_scss_ = __webpack_require__("3df2");
...
// CONCATENATED MODULE: ./src/EcomSearch.vue
...
var component = normalizeComponent(
  src_EcomSearchvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var EcomSearch = (component.exports);
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (EcomSearch);
...
//# sourceMappingURL=EcomSearch.umd.js.map