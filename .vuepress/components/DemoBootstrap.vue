    ...
    <div v-if="showToasts">
      ...
      <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-delay="3000">
        <div class="toast-header">
          <img src="/assets/img/logo.png" class="rounded mr-2" alt="...">
